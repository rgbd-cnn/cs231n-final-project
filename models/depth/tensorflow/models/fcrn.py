...
class ResNet50UpProj(Network):
    def setup(self):
        ...
        (self.feed('bn5a_branch1',
             ...
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res5b_branch2a', trainable=True)
             .batch_normalization(relu=True, name='bn5b_branch2a')
             .conv(3, 3, 512, 1, 1, biased=False, relu=False, name='res5b_branch2b', trainable=True)
             .batch_normalization(relu=True, name='bn5b_branch2b')
             .conv(1, 1, 2048, 1, 1, biased=False, relu=False, name='res5b_branch2c', trainable=True)
        ...
        (self.feed('res5a_relu',
             ...
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res5c_branch2a', trainable=True)
             .batch_normalization(relu=True, name='bn5c_branch2a')
             .conv(3, 3, 512, 1, 1, biased=False, relu=False, name='res5c_branch2b', trainable=True)
             .batch_normalization(relu=True, name='bn5c_branch2b')
             .conv(1, 1, 2048, 1, 1, biased=False, relu=False, name='res5c_branch2c', trainable=True)
        ...
        (self.feed('res5b_relu',
             ...
             .dropout(name = 'drop', keep_prob = .7)
             .conv(3, 3, 1, 1, 1, name = 'ConvPred', trainable=True))
